...
(function($, window, undefined){
  ...
  Hangman = {
    ...
    win: function(){
      ...
      this.msgTitle.html("Awesome, You Found The Location.");
      this.showMsg();
    ...
    lose: function(){
      this.msgTitle.html("You Lost...");
      this.msgText.html("Don't worry, you'll get the location next tine!");
      this.showMsg();
  ...
  var wordList = ["Dusseldorf","Cologne","Essen","Duisburg","Wuppertal" ,"Konigsberg", "Dortmund","hamburg","Bremen","Chemnitz"];
